namespace Modelo
{
    public class Equipo
    {
        ...
        public Equipo(string pId_Equipo, string pNombre_Equipo, bool pEstado_Equipo, int pId_Ubicacion, string pNombre_Ubicacion, int pId_Conexion, string pNombre_Conexion, bool pSin_Conexion_Equipo)
        {
