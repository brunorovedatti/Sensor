namespace Modelo
{
    public class Variable
    {
        ...
        public Variable(string pId_Variable, string pNombre_Variable, string pDescripcion_Variable, string pUnidad_Variable, bool pEstado_Variable, string pId_Equipo, string pAlerta_Variable, string pOperador_Alerta_Variable, bool pAlerta_Notificada)
        {
